import signupImage from "@/public/auth/signup.jpg";
      ...
      <div className="flex h-full max-h-[40rem] w-full max-w-[64rem] rounded-2xl overflow-hidden shadow-2xl bg-card">
        <div className="md:w-1/2 w-full space-y-10 overflow-y-auto p-10">
          <div className="space-y-1 text-center">
            <h1 className="text-3xl font-bold">Signup to Quikref</h1>
            <p className="text-muted-foreground">Your ultimate destination for mastering anything!</p>
          </div>
